#!/usr/bin/env python3
"""
📊 Creación de Datos Completos para Verificación del Sistema
Este script crea datos de prueba completos para todas las tablas del dashboard
"""
...
def create_comprehensive_test_data():
    """📊 Crear datos de prueba completos para todas las tablas"""
    ...
    try:
        ...
        with SessionLocal() as db:
            # 1. Crear Pacientes Críticos (Medical Records Extended)
            ...
            surgeries_data = [
                {
                    ...
                    "surgeon_id": "vet_001",
                    "assistant_ids": '["vet_002"]',  # JSON como string
                    "operating_room": "OR-1",
                    "equipment_needed": '["Bisturí eléctrico", "Equipo de anestesia", "Monitor vital"]',  # JSON como string
                ...
                },
                {
                    ...
                    "surgeon_id": "vet_002",
                    "assistant_ids": '["vet_001"]',  # JSON como string
                    "operating_room": "OR-2",
                    "equipment_needed": '["Equipo de esterilización", "Equipo de anestesia"]',  # JSON como string
                ...
                },
                {
                    ...
                    "surgeon_id": "vet_001",
                    "assistant_ids": '[]',  # JSON como string
                    "operating_room": "Dental-1",
                    "equipment_needed": '["Equipo dental", "Anestesia local"]',  # JSON como string
            ...
            print("✅ Datos de prueba completos creados exitosamente")
            return True
...
def main():
    """🚀 Ejecutar creación y verificación de datos"""
    print("🚀 INICIANDO CREACIÓN DE DATOS COMPLETOS")
    print("=" * 60)
    
    # Crear datos completos
    if create_comprehensive_test_data():
        # Verificar datos creados
        if verify_created_data():
            print("\n🎉 ¡DATOS COMPLETOS CREADOS Y VERIFICADOS!")
            print("\n📋 Resumen:")
